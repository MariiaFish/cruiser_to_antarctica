...
/* harmony import */ var _modules_modals_navigation_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/navigation-menu */ "./js/modules/modals/navigation-menu.js");
/* harmony import */ var _modules_modals_form_setting__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/form-setting */ "./js/modules/modals/form-setting.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_modals_navigation_menu__WEBPACK_IMPORTED_MODULE_2__["setNavigationMenu"])();
  Object(_modules_modals_form_setting__WEBPACK_IMPORTED_MODULE_3__["setForm"])();
...
/***/ "./js/modules/modals/form-setting.js":
/*!*******************************************!*\
  !*** ./js/modules/modals/form-setting.js ***!
  \*******************************************/
...
var elementFormHandler = function elementFormHandler(element) {
  return function () {
...
var setFormButton = function setFormButton(button) {
  button.addEventListener('click', clearStorage);
};
var setFormElement = function setFormElement(element, handler) {
  element.addEventListener('change', handler(element));
};
var setFormElements = function setFormElements(formElements) {
...
/***/ "./js/modules/modals/navigation-menu.js":
/*!**********************************************!*\
  !*** ./js/modules/modals/navigation-menu.js ***!
  \**********************************************/
/*! exports provided: setNavigationMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setNavigationMenu", function() { return setNavigationMenu; });
var CLOSE_ATTRIBUTE_VALUE = 'close';
var OPEN_ATTRIBUTE_VALUE = 'open';
var ATTRIBUTE_BUTTON_TOGGLE = 'data-navigation-toggle-btn';
var ATTRIBUTE_NAVIGATION_MENU = 'data-navigation-menu';
var NO_JS_CLASS_NAME = 'wrapper--no-js';
...
var headerMenu = bodyWrapper && bodyWrapper.querySelector('.header');
var navigationMenuToggle = headerMenu && headerMenu.querySelector('.header__navigation-btn');
var menuNavigationItems = headerMenu && headerMenu.querySelectorAll('.link--navigation-header');
var setAttributeToClose = function setAttributeToClose(element, attributeName) {
  return element.setAttribute(attributeName, CLOSE_ATTRIBUTE_VALUE);
};
var setAttributeToOpen = function setAttributeToOpen(element, attributeName) {
  return element.setAttribute(attributeName, OPEN_ATTRIBUTE_VALUE);
};
var isOpenAtribute = function isOpenAtribute(elemnt, attributeName) {
  return elemnt.getAttribute(attributeName) === OPEN_ATTRIBUTE_VALUE;
};
var lockBodyScroll = function lockBodyScroll() {
  return body.classList.add(SCROLL_LOCK);
};
var unlockBodyScroll = function unlockBodyScroll() {
  return body.classList.remove(SCROLL_LOCK);
};
var setNavigationMenuToClose = function setNavigationMenuToClose() {
...
var setNavigationMenuToOpen = function setNavigationMenuToOpen() {
  setAttributeToOpen(navigationMenuToggle, ATTRIBUTE_BUTTON_TOGGLE);
  setAttributeToOpen(bodyWrapper, ATTRIBUTE_NAVIGATION_MENU);
  lockBodyScroll();
};
var buttonClickHeandler = function buttonClickHeandler(button) {
...
var setButtonHeandler = function setButtonHeandler(button) {
  if (button) {
    button.addEventListener('click', function () {
      return buttonClickHeandler(button);
    });
  }
};
var setMenuNavigatuinItem = function setMenuNavigatuinItem(item) {
  if (item) {
    item.addEventListener('click', function () {
      return setNavigationMenuToClose();
    });
  }
};
var setBodyOverlay = function setBodyOverlay(item) {
  if (item) {
    item.addEventListener('click', function () {
      return setNavigationMenuToClose();
    });
...
var setMenuNavigationItems = function setMenuNavigationItems(menuItems) {
  if (menuItems[0]) {
...
var setNavigationMenu = function setNavigationMenu() {
